...
for(const location of ['.agents/skills','.claude/skills']) cpSync(join(root,'skills/setup-team-guidance'),join(work,location,'setup-team-guidance'),{recursive:true});
...
else if(phase==='missing') prompt='Use setup-team-guidance to set up team guidance for Northstar using the collaboration MCP. Preserve existing instructions. Do not inspect or modify .fixture.';
else if(phase==='ambiguous') prompt='Use setup-team-guidance to set up team guidance here. The intended team has not been chosen and this test project does not imply one. Do not inspect or modify .fixture.';
